...
const create_register_1 = require("./dto/create-register");
let RegisterController = class RegisterController {
    ...
    createUser(userDto) {
        return `Usuario creado: ${userDto.name}`;
    }
    updateUser(userDto) {
        return `usuario ${userDto.name} actualizado`;
    }
    deleteUser(idUser) {
        return `usuario ${idUser} eliminado`;
    }
};
__decorate([
    common_1.Get(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_register_1.CreateRegisterDto]),
    __metadata("design:returntype", String)
